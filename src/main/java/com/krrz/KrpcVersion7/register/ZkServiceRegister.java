package com.krrz.KrpcVersion7.register;

import com.krrz.KrpcVersion7.loadBalance.LoadBalance;
import com.krrz.KrpcVersion7.loadBalance.RandomLoadBalance;
    ...
    public void register(String serviceName, InetSocketAddress serverAddress) {
        try {
            ...
            if(client.checkExists().forPath("/"+serviceName)==null){
                client.create().creatingParentsIfNeeded().withMode(CreateMode.EPHEMERAL).forPath("/"+serviceName);
            }
            //路径地址，一个/代表一个节点
